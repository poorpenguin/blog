<?php
/* Smarty version 3.1.29, created on 2017-10-30 09:47:35
  from "D:\wamp\www\blog\App\Home\View\Index\index.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59f6e72763f787_22958483',
  'file_dependency' => 
  array (
...
function content_59f6e72763f787_22958483 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<!--[if lt IE 9]>
    <?php echo '<script'; ?>
 src="js/html5shiv.min.js" type="text/javascript"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="js/respond.min.js" type="text/javascript"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="js/selectivizr-min.js" type="text/javascript"><?php echo '</script'; ?>
>
<![endif]-->
...
/img3.jpg" alt="" /></a>
      ...
      <div class="content-block hot-content hidden-xs">
        ...
        <ul>
          <li class="large"><a href="content.html" target="_blank"><img src="<?php echo @constant('IMAGE_DIR');?>
/img3.jpg" alt="">
            <h3> 欢迎来到个人技术博客技术博客 </h3>
            </a></li>
          <li><a href="content.html" target="_blank"><img src="<?php echo @constant('IMAGE_DIR');?>
/logo.jpg" alt="">
