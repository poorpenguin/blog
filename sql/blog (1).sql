...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-11-10 10:27:21
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(1, 'poorpenguin', 'e10adc3949ba59abbe56e057f20f883e', '::1', 17, 1510280242);
...
CREATE TABLE IF NOT EXISTS `bg_article` (
  ...
  `reply_nums` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '评论数',
...
CREATE TABLE IF NOT EXISTS `bg_comment` (
  `cmt_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论主键',
  `art_id` smallint(5) unsigned DEFAULT NULL COMMENT '外键，文章id',
  `user_name` varchar(20) NOT NULL COMMENT '外键,用户名',
...
INSERT INTO `bg_comment` (`cmt_id`, `art_id`, `user_name`, `cmt_content`, `cmt_time`) VALUES
(1, 10, 'poorpenguin', '12312323', 1510195458),
(2, 10, 'poorpenguin', '测试23333333333333333', 1510195783),
(3, 10, 'poorpenguin', '评论测试1', 1510205057),
(4, 10, 'poorpenguin', '评论测试2', 1510205070),
(5, 10, 'poorpenguin', '评论测试3', 1510205097),
(6, 10, 'poorpenguin', '评论测试4', 1510205102),
(7, 10, 'poorpenguin', '评论测试5', 1510205106),
(8, 10, 'poorpenguin', '评论测试6', 1510205111),
(9, 10, 'poorpenguin', '评论测试7', 1510205115),
(10, 10, 'poorpenguin', '评论测试8', 1510205119),
(11, 10, 'poorpenguin', '评论测试9', 1510205124),
(12, 10, 'poorpenguin', '10', 1510205127),
(13, 10, 'poorpenguin', '11', 1510205131),
(14, 10, 'poorpenguin', '12', 1510205133),
(15, 7, 'poorpenguin', '123', 1510277934),
(16, 7, 'poorpenguin', '1213123', 1510277938),
(17, 7, 'poorpenguin', '123123123', 1510277941),
(18, 7, 'poorpenguin', '124124124', 1510277944),
(19, 10, 'poorpenguin', '123123', 1510281063),
(20, 10, 'poorpenguin', '12312313123', 1510281562),
(21, 10, '不良企鹅', '12312313', 1510300349);
...
(2, '不良企鹅', 'e10adc3949ba59abbe56e057f20f883e', 'default.jpg', 1510300315);
...
ALTER TABLE `bg_comment`
  ADD CONSTRAINT `bg_comment_ibfk_1` FOREIGN KEY (`art_id`) REFERENCES `bg_article` (`art_id`),
  ADD CONSTRAINT `bg_comment_ibfk_2` FOREIGN KEY (`user_name`) REFERENCES `bg_user` (`user_name`);
